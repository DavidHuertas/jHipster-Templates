...
To optimize the jHipsterMicroservices application for production, run:
...
[Service Discovery and Configuration with Consul]: https://www.jhipster.tech/documentation-archive/v5.0.1/microservices-architecture/#consul
