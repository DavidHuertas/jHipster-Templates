# jHipster_Monolithic
Esta plantilla se ha creado con la intención de aprender a separar el back-end del front-end de un proyecto generado con jHipster.
...
To optimize the jHipster_Monolithic application for production, run:
