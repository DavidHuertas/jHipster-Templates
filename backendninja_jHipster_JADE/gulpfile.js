// Generated on 2018-04-23 using generator-jhipster 4.14.3
'use strict';
...
gulp.task('install', function () {
    runSequence(['inject:dep', 'ngconstant:dev'], 'sass', 'jade', 'copy:languages', 'inject:app', 'inject:troubleshoot');
});
